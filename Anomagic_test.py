...
class MetaUASWrapper:
    ...
    def __init__(self, ckt_path='weights/metauas-256.ckpt', img_size=256):
        set_random_seed(1)
    ...
    def evaluate_quality(self, generated_image, reference_image):
        ...
        return results
def load_models(ip_ckpt, ip_ckpt_1, base_model_path, vae_model_path, image_encoder_path, device):
    ...
    anomagic_model = Anomagic(pipe, image_encoder_path, ip_ckpt, ip_ckpt_1, device)
    timer.checkpoint("IP adapter loaded")
    return anomagic_model
...
def generate_with_quality_control(
    ...
    while successful_samples < num_samples_target and attempt_count < max_attempts:
        ...
        images = anomagic_model.generate(
...
def main():
    ...
    parser.add_argument("--ip_ckpt", type=str, default="",
                        help="IP Adapter模型 checkpoint 路径")
    parser.add_argument("--ip_ckpt_1", type=str, default="",
                        help="IP Adapter模型 checkpoint 路径")
    parser.add_argument("--base_model_path", type=str, default="SG161222/Realistic_Vision_V4.0_noVAE",
    ...
    parser.add_argument("--quality_model_path", type=str, default="weights/metauas-256.ckpt",
                        help="Quality assessment model path")
    # Dataset path parameters
    parser.add_argument("--dataset_type", type=str, choices=["mvtec", "visa"], default="visa",
                        help="Dataset type (mvtec/visa)")
    parser.add_argument("--similarity_results", type=str,
                        default="",
    ...
    parser.add_argument("--anomaly_image_base", type=str,
                        default="",
                        help="Anomaly image base path")
    parser.add_argument("--merged_datasets", type=str,
                        default="",
